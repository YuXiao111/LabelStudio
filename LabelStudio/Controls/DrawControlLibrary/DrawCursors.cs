...
namespace LabelStudio.Controls.DrawControlLibrary
{
    public static class DrawCursors
    {
        ...
        private static Lazy<Cursor> hand = new Lazy<Cursor>(() => { return CreateBmpCursor(new Uri("Assets/Images/hand.png", UriKind.Relative), 12, 12); });
        /// <summary>
        /// 拖动
        /// </summary>
